defmodule EducativeWeb.CourseControllerTest do
  use EducativeWeb.ConnCase

  import Educative.ELearningFixtures

  @create_attrs %{author: "some author", description: "some description", free: true, title: "some title"}
